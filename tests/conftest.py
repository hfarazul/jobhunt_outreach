...
def env(tmp_path: Path) -> dict[str, str]:
    ...
    return {
        ...
        "ACTION_DELAY_MAX": "0",
        "DRY_RUN": "0",
        # Some lookups fire secondary sub-queries whose shape collides with
        # FakeAdapter's default query-echo headlines. Default to empty results
        # for those so happy-path integration tests work; tests that exercise
        # that flow explicitly remove this key.
